...
function setupDevServer(config) {
  config.setupMiddlewares = (middlewares, devServer) => {
    ...
    const isAllowedOrigin = (origin) => {
      ...
      // Allow localhost and your custom domains
      ...
      try {
        ...
        Object.entries(changesByFile).forEach(([fileName, fileChanges]) => {
          ...
          try {
            ...
            execSync(`git -c user.name="visual-edit" -c user.email="your-email@example.com" add "${targetFile}"`);
            execSync(`git -c user.name="visual-edit" -c user.email="your-email@example.com" commit -m "visual_edit_${timestamp}"`);
          } catch (gitError) {
